                ...
                try
                {
                    ...
                    else
                    {
                        string strsql2 = "UPDATE cliente SET " +
                            ...
                            "ida_cli = " + int.Parse(textBox4.Text.Trim()) + "," +
                            "num_cli = " + "'" + textBox5.Text.Trim() + "'" + "," +
                            "rua_cli = " + "'" + textBox6.Text.Trim() + "'" + "," +
                            "bai_cli = " + "'" + textBox7.Text.Trim() + "'" + "," +
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    {
                        string strsql2 = "DELETE FROM cliente WHERE cod_cli = " + codigo;
