...
namespace lapoindustries
{
    public partial class produtos : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                string strsql = "INSERT INTO produto(cod_pro,cor_pro,tip_pro,tam_pro,qua_pro,emb_pro,tra_pro,cli_pro,des_pro) " +
                                              "VALUES (" +
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string strsql = "SELECT * FROM produto WHERE cod_pro = " + codigo;
                try
                {
                    MySqlCommand cmd = new MySqlCommand(strsql, conn);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    {
                        string strsql2 = "UPDATE produto SET " +
                            "cor_pro = " + "'" + textBox2.Text.Trim() + "'" + "," +
                            "tip_pro = " + "'" + textBox3.Text.Trim() + "'" + "," +
                            "tam_pro = " + "'" + textBox4.Text.Trim() + "'" + "," +
                            "qua_pro = " + int.Parse(textBox5.Text.Trim()) + "," +
                            "emb_pro = " + "'" + textBox6.Text.Trim() + "'" + "," +
                            "tra_pro = " + "'" + textBox7.Text.Trim() + "'" + "," +
                            "cli_pro = " + "'" + textBox8.Text.Trim() + "'" + "," +
                            "des_pro = " + "'" + textBox9.Text.Trim() + "'" +
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    {
                        string strsql2 = "DELETE FROM produto WHERE cod_pro = " + codigo;
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string nomeTabela = "produto"; // 🔹 Você pode trocar depois para cliente, fornecedor, etc.
